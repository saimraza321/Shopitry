...
<div class="row page-titles">
   ...
   <div class="card">
        <div class="card-body">
            <h3 class="card-title">Add Top Selling</h3>
            <form class="form" name="formCreate" id="formCreate" method="POST" action="{{ route('top_selling.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control" name="oldprice" required>
                    </div>
                    <div class="form-group col-6">
